...
export default function DModels({ pageProps, opositeModels }) {
    ...
    useEffect(() => {
        (async () => {
            ...
            const where = {
                _where: [
                    { 'd_categories.url_in': query.kategoria },
            ...
            const getResponseD = getDModelsByCustomProps(getModels);
            const getResponseDCount = getDModelsByCustomPropsCount(getModels);
...
export async function getServerSideProps(context) {
    ...
    const getResponse = getModelsByCustomProps(getModels);
    const getResponseCount = getModelsByCustomPropsCount(getModels);
